    ...
    with open(caminho_arquivo, "r") as arquivo:
        ...
        for linha in arquivo:
            ...
            if len(partes) >= 8:
                ...
                if "." in ipv and ultimo_elemento not in sistemas_ipv4:
                    sistemas_ipv4.add(ultimo_elemento)
                    total_anunciando_ipv4 += 1
                elif ":" in ipv and ultimo_elemento not in sistemas_ipv6:
                    sistemas_ipv6.add(ultimo_elemento)
                    total_anunciando_ipv6 += 1

        # pegando quantidade de sistemas autonomos com anunciando_ambos (ipv4 e ipv6) e com somente ipv4
